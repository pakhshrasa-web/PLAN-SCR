...
class UserScreen(Screen):
    ...
    def build_ui(self):
        try:
            ...
            visit_date.disabled = True
            self.form_layout.add_widget(visit_date)
            # هدف تاریخ ویزیت = تاریخ روز جاری (با Label معمولی)
            ...
            # هدف مسیر ویزیت = تعداد مشتریان مسیر (با Label معمولی - طلایی)
            ...
            # هدف ساعت شروع کار = از تنظیمات (با Label معمولی)
            ...
            first_visit_time.disabled = True
            self.form_layout.add_widget(first_visit_time)
            # هدف ساعت اولین ویزیت = از تنظیمات (با Label معمولی)
            ...
            visited_count.disabled = True
            self.form_layout.add_widget(visited_count)
            # هدف تعداد مشتری ویزیت شده (با Label معمولی)
            ...
            invoices_count.disabled = True
            self.form_layout.add_widget(invoices_count)
            # هدف تعداد فاکتور موفق = از تنظیمات (با Label معمولی)
            ...
            units_count.disabled = True
            self.form_layout.add_widget(units_count)
            # هدف تعداد واحد فروش موفق = از تنظیمات (با Label معمولی)
            ...
            sales_amount.disabled = True
            self.form_layout.add_widget(sales_amount)
            # هدف مبلغ فروش موفق = از تنظیمات (با Label معمولی)
            ...
            last_visit_time.disabled = True
            self.form_layout.add_widget(last_visit_time)
            # هدف ساعت آخرین ویزیت (با Label معمولی)
            ...
            # هدف ساعت پایان کار (با Label معمولی)
    ...
    def lock_page(self):
        ...
        try:
            ...
            for key, input_field in self.inputs.items():
                if hasattr(input_field, 'disabled'):
